...
const staticEvents = [
  ...
  },
  {
    ...
    featured: false,
    hiddenGem: true,
    tags: ['mural', 'walking tour', 'community', 'public art', 'family friendly'],
    accessibilityBadges: ['Outdoor route — pace may vary', 'Wheelchair-friendly route'],
    latitude: 37.5491,
    longitude: -77.4377,
    _startOffsetDays: 2,
    _startHour: 10,
  ...
  },
  {
    ...
    featured: false,
    hiddenGem: true,
    tags: ['poetry', 'open mic', 'literary', 'multilingual welcome'],
    accessibilityBadges: ['Transit-friendly — Pulse nearby'],
    latitude: 37.5269,
    longitude: -77.4177,
    _startOffsetDays: 3,
    _startHour: 19,
